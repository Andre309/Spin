document.addEventListener("DOMContentLoaded", function() {
    ...
    const stories = [
      ...
      "Весь наступний раунд говори тільки словами, які починаються на букву ",
        "Виголоси тост, використовуючи всі слова на букву ",
        "Розкажи, що б ти зробив, якби став невидимкою, використовуючи всі слова на букву ",
        "Розкажи, як би ти описав себе на співбесіді, використовуючи всі слова на букву ",
        "Придумай нову професію, описуючи її словами на букву ",
        "Розкажи, про свій перший день у ролі президента, використовуючи всі слова на букву ",
        "Придумай сценарій фільму, де всі події відбуваються на букву ",
        "Виголоси промову, наче ти отримав оскар, використовуючи всі слова на букву ",
        "Опиши присутніх, використовуючи всі слова на букву ",
        "Придумай діалог між алкашами, використовуючи всі слова на букву ",
        "Придумай листа самому собі з майбутнього, використовуючи всі слова на букву "
    ];
    //Масив букв
    ...
    const exercies = [
        ...
        "Планка (в секундах) ",
        "Оберти головою ",
        "Зроби оберти тулубом ",
        "Встань на одну ногу та тримай рівновагу ",
        "Виконай віджимання з стрибком (берпі) "
    ];
    //Кількість спроб
    ...
    const emotions2 = [
        ...
        "дуже щасливий",
        "на межі істерики",
        "апатично (повна байдужість)",
        "переповнений енергією",
        "як справжній геній",
        "як лідер секти",
        "з несамовитою злістю",
        "наче ти секретний агент",
        "з непохитною впевненістю",
        "наче в тебе зіркова хвороба",
        "як актор у драматичній сцені (перегравай)",
        "на грані сліз",
        "як злий кіт",
        "наче тебе ніхто не бачить",
        "як людина, яка вражена несподіваною новиною",
        "з абсолютною відданістю грі",
        "наче ти тільки що виграв мільйон доларів",
        "з холодним цинізмом",
        "як персонаж з мультфільму",
        "як людина, яка нічого не розуміє",
        "як учений на межі відкриття",
        "з величезною гордістю",
        "наче ти тільки що закохався",
        "як у страху перед чимось незрозумілим",
        "з надзвичайною підозрою",
        "наче ти відчуваєш сором",
        "як король, який після гри має стратити інших учасників",
        "наче ти на королівському балу",
        "наче ти не розумієш свою рідну мову",
        "наче ти виявив у себе невідому хворобу"
    ]
    //Імпровізація
    const laught = [
        ...
        "Весь наступний раунд чаклуй на свою перемогу",
        ...
        "Веди себе, наче ти тракторист-космонавт"
    ];
    //Розкажи з акцентом
    const accent = [
        ...
        "Розкажи про своє хоббі з ",
        "Роздай поради усім з ",
        "Зачитай реп з "
    ];
    //Види акцентів
    const accent2 = [
...
function changeCategoryColor(button) {
    ...
    // Функція для генерації завдання з емоціями
