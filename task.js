document.addEventListener("DOMContentLoaded", function() {
    ...
    const stories = [
      ...
      "Весь наступний раунд говори тільки словами, які починаються на букву ",
        "Виголоси тост, використовуючи слова тільки на букву ",
        "Розкажи, що б ти зробив, якби став невидимкою, використовуючи слова тільки на букву ",
        "Розкажи, як би ти описав себе на співбесіді, використовуючи слова тільки на букву ",
        "Придумай нову професію, описуючи її словами тільки на букву ",
        "Розкажи, про свій перший день у ролі президента, використовуючи слова тільки на букву ",
        "Придумай сценарій фільму, де всі події відбуваються навколо слова на букву ",
        "Виголоси промову, наче ти отримав оскар, використовуючи слова тільки на букву ",
        "Опиши присутніх, використовуючи слова тільки на букву ",
        "Придумай діалог між алкашами, використовуючи слова тільки на букву ",
        "Придумай листа самому собі з майбутнього, використовуючи слова тільки на букву "
    ];
    //Масив букв
